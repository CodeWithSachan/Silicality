...
export default function Footer() {
  return (
    ...
    {/* Optional brand text – remove if logo-only */}
  ...
  <p className="mt-4 max-w-md text-sm leading-relaxed text-neutral-400">
    AI-driven products, programs, and platforms — built openly and
    responsibly.
  </p>
</div>

{/* Explore + Company (mobile parallel) */}
      ...
      Contact
        ...
        border-t border-neutral-800 pt-5 sm:pt-6 text-xs text-neutral-500 md:flex-row">
          ...
          <p className="text-neutral-400">
            Building For Future • Feedback welcome
          </p>
        </div>
      </div>
    </footer>
