      ...
      <div className="max-w-6xl mx-auto space-y-28">
        ...
        <div className="grid gap-12 md:grid-cols-2 items-start">
          ...
          <motion.div
            ...
            className="rounded-2xl border border-neutral-800 bg-neutral-900/50 backdrop-blur
            p-6 sm:p-8"
          >
            ...
            {[
              {
                ...
                desc:
                  "Support hackathons, challenges, and seasonal programs with meaningful brand presence and contributor engagement.",
              },
              {
              ...
              },
              {
                ...
                desc:
                  "Collaborate on long-term initiatives that nurture learning, mentorship, and contribution.",
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
        ...
        <motion.div
          ...
          px-6 sm:px-12 py-14 sm:py-18 text-center"
        >
          <h2 className="text-2xl sm:text-3xl font-semibold">
